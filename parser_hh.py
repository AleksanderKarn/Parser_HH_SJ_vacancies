...
from parser_sj import Engine

url = 'https://hh.ru'
file_name = 'hh_vacancies.json'
ua = FU.UserAgent()
...
#
#    for i in range(
#            page_count() + 1):  # основной цикл програмы проходящий по каждой странице в зависимости от их колличества
#        if i == 0:
#            continue
...
vac_hh = HH(url, 'hh_vacancies.json')

print(vac_hh.get_request())